...
BOT_NAME = getenv("BOT_NAME", "˹𝗣𝗥𝗜𝗦𝗛𝗨 𝗠𝗨𝗦𝗜𝗖˼ ♪")
ASSUSERNAME = getenv("ASSUSERNAME", "PRISHUxASSISTANT")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/MAHTO-ANJALI/PRISHUxMUSIC")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# Support and contact information - Provide your own support channels
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/RBGOFFICIAL1")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/NEON_SUKOON")
...
PING_VID_URL = getenv(
    "PING_VID_URL", "https://telegra.ph/file/9b7e1b820c72a14d90be7.mp4"
)
